...
const TermsConditions = () => {
  ...
  useEffect(() => {
    if (localStorage.getItem("customer_authentication_token")) {
      document.title =
        "Terms & Conditions ||  Quantania - An efficient computer programs and application source code provider";
    } else {
  ...
  return (
    <div className="container mb-5 mt-5">
      ...
      <p>Last updated: 2022-10-01</p>
      <p>
        1. <b>Introduction</b>
      </p>
      <p>
        Welcome to <b>Quantania</b> (“Company”, “we”, “our”, “us”)!
      </p>
      <p>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at <b>https://www.quantania.ml</b> (together or
        individually “Service”) operated by <b>Quantania</b>.
      </p>
      <p>
      ...
      <p>
        ...
        <b>quantania@outlook.in</b> so we can try to find a solution. These
      ...
      <p>
        ...
        following the unsubscribe link or by emailing at quantania@outlook.in.
      </p>
      <p>
        3. <b>Purchases</b>
      </p>
      ...
      <p>
        Quantania has the right but not the obligation to monitor and edit all
        Content provided by users.
      </p>
      <p>
        In addition, Content found on or through this Service are the property
        of Quantania or used with permission. You may not distribute, modify,
      ...
      <p>
        ...
        Quantania and its licensors. Service is protected by copyright,
      ...
      <p>
        ...
        to quantania@outlook.in, with the subject line: “Copyright Infringement”
      ...
      <p>
        You can contact our Copyright Agent via email at quantania@outlook.in.
      </p>
      <p>
        14. <b>Error Reporting and Feedback</b>
      </p>
      <p>
        You may provide us either directly at quantania@outlook.in or via third
      ...
      <p>
        ...
        are not owned or controlled by Quantania.
      </p>
      <p>
        Quantania has no control over, and assumes no responsibility for the
      ...
      <p>
        ...
        email: <b>quantania@outlook.in</b>.
      </p>
    </div>
  );
};
