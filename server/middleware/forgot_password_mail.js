...
const forgot_password_mail = async (
  ...
  try {
    ...
    const mailOptions = {
      ...
      to: administrator_email_id,
      subject: "Forgot password - Quantania || Admin Panel",
      html: `<!DOCTYPE html>
      <html
      ...
      >
        <head>
          ...
          <script>
            ...
            let username_value = recipient_username
            username.innerHTML = username_value
          </script>
          <style type="text/css">
            body,
            p,
                                                                        ...
                                                                        >
                                                                          <span
                                                                            style="
                                                                              font-size: 43px;
                                                                            "
                                                                            >Howdy, ${administrator_username} !&nbsp;</span
                                                                          >
                                                                        </div>
                                                                        <div></div>
                                                                      </div>
                                                                      ...
                                                                      <div>
                                                                        ...
                                                                        >
                                                                          <span
                                                                            ...
                                                                            "
                                                                            >Please
                                                                            click on the button below to</span
                                                                          ><span
                                                                            style="
                                                                              color: #000000;
                                                                              font-size: 18px;
                                                                            ...
                                                                            "
                                                                          >
                                                                            set a new password for your administrator account</span
                                                                          ><span
                                                                            style="
                                                                              font-size: 18px;
                                                                            "
                                                                      ...
                                                                      >
                                                                        <tbody>
                                                                          <tr>
                                                                            ...
                                                                            >
                                                                              <a
                                                                                href=${process.env.ADMIN_PANEL_URL}/#/admin_panel/forgot_password?administrator_authentication_token=${administrator_authentication_token}
                                                                                style="
                                                      ...
                                                      >
                                                        <tbody>
                                                          <tr>
                                                            ...
                                                            >
                                                              <a
                                                                href=${process.env.ADMIN_PANEL_URL}/#/admin_panel/dashboard
                                                                style="
