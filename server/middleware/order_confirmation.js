...
const order_confirmation = async (email_id) => {
  try {
    ...
    const mailOptions = {
      ...
      to: email_id,
      subject: `Order Placed Successfully || Quantania`,
      html: `<!DOCTYPE html>
      <html
                                                                        ...
                                                                        >
                                                                          <span
                                                                            style="
                                                                              font-size: 18px;
                                                                            "
                                                                            >You can view your order details from the My Account section</span
                                                                          ><span
                                                                            style="
                                                                              color: #000000;
                                                                              font-size: 18px;
                                                                            ...
                                                                            "
                                                                          >
                                                                          and also take a look on our variety of products
                                                                          </span
                                                                          ><span
                                                                            style="
                                                                              font-size: 18px;
                                                                      ...
                                                                      >
                                                                        <tbody>
                                                                          <tr>
                                                                            ...
                                                                            >
                                                                              <a
                                                                                href=${process.env.CLIENT_SIDE_URL}/account/orders
                                                                                style="
...
module.exports = order_confirmation;
